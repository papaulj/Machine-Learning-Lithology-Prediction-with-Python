...
A Random Forest classifier was implemented to predict lithology using well log measurements (GR, DPHI, NPHI, ILD.
Workflow:
    Data cleaning
    Feature selection
    Model training
...
This project concisely demonstrates how machine learning can support reservoir characterization workflows.
